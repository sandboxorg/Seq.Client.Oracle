...
define SEQ_HOST     = '???';  -- Set here the host name (and path, if any) on which Seq is listening
define SEQ_PORT     = 5341;   -- Set here the port number on which Seq is listening - Default is 5341
